...
owner) => {
    ...
    const accountRent = await connection.getMinimumBalanceForRentExemption(spl_token_1.MintLayout.span);
    ...
    transaction.add(spl_token_1.Token.createSetAuthorityInstruction(TOKEN_PROGRAM_ID, mintAccount.publicKey, null, wallet.publicKey, []));
