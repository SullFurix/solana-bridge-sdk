...
function WalletProvider({ children = null }) {
    ...
    return (react_1.default.createElement(WalletContext.Provider, { value: {
        ...
        children,
        react_1.default.createElement(antd_1.Modal, { title: "Select Wallet", okText: "Connect", visible: isModalVisible, okButtonProps: { style: { display: 'none' } }, onCancel: close, width: 400 }, exports.WALLET_PROVIDERS.map((provider, idx) => {
